...
CREATE TABLE `emp_skill` (
  ...
  PRIMARY KEY (`emp_no`,`skill_no`),
  KEY `skill_no` (`skill_no`),
  CONSTRAINT `emp_skill_ibfk_1` FOREIGN KEY (`emp_no`) REFERENCES `employee` (`emp_no`),
  CONSTRAINT `emp_skill_ibfk_2` FOREIGN KEY (`skill_no`) REFERENCES `skills` (`skill_no`)
...
-- Dump completed on 2021-05-17 11:51:57
