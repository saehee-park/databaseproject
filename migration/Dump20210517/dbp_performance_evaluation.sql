...
CREATE TABLE `performance_evaluation` (
  ...
  PRIMARY KEY (`evaluator_no`,`non_evaluator_no`),
  KEY `non_evaluator_no` (`non_evaluator_no`),
  CONSTRAINT `performance_evaluation_ibfk_1` FOREIGN KEY (`evaluator_no`) REFERENCES `employee` (`emp_no`),
  CONSTRAINT `performance_evaluation_ibfk_2` FOREIGN KEY (`non_evaluator_no`) REFERENCES `employee` (`emp_no`)
...
-- Dump completed on 2021-05-17 11:52:02
